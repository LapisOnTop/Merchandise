    ...
    <ul class="nav-list">
        <li class="nav-section">
            <div class="nav-section-title" data-expanded="false">
                ...
                <span class="nav-section-label">Fleet and Vehicle Management</span>
        ...
        <li class="nav-section">
            <div class="nav-section-title" data-expanded="false">
                <span class="nav-section-icon" aria-hidden="true">👥</span>
                <span class="nav-section-label">Vehicle Reservation and Dispatch</span>
                <span class="nav-icon" aria-hidden="true">▾</span>
            </div>
            <ul class="nav-sublist">
...
<div class="main" id="mainContent">
    <div class="page-header">
        <h2>Logistic 2 Dashboard</h2>
    </div>

    <div class="card">
        <h3>Welcome</h3>
        <p>This is the Logistic 2 workspace. Use the sidebar navigation to get started.</p>
    </div>
</div>
